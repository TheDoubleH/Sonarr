...
namespace NzbDrone.Core.Indexers.Newznab
{
    ...
    public class NewznabSettings : IIndexerSettings
    {
        ...
        [FieldDefinition(3, Label = "Categories", Type = FieldType.Select, SelectOptionsProviderAction = "getCategories", HelpText = "Comma Separated list, leave blank to disable standard/daily shows")]
        public IEnumerable<int> Categories { get; set; }

        [FieldDefinition(4, Label = "Anime Categories", Type = FieldType.Select, SelectOptionsProviderAction = "getCategories", HelpText = "Comma Separated list, leave blank to disable anime")]
