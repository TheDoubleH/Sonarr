...
namespace NzbDrone.Core.Test.IndexerTests.FileListTests
{
    ...
    public class FileListFixture : CoreTest<FileList>
    {
        ...
        public void should_parse_recent_feed_from_FileList()
        {
            ...
            torrentInfo.DownloadUrl.Should().Be("https://filelist.ro/download.php?id=1234&passkey=somepass");
            torrentInfo.InfoUrl.Should().Be("https://filelist.ro/details.php?id=1234");
            torrentInfo.CommentUrl.Should().BeNullOrEmpty();
            torrentInfo.Indexer.Should().Be(Subject.Definition.Name);
            torrentInfo.PublishDate.Should().Be(DateTime.Parse("2019-01-22 22:20:19"));
